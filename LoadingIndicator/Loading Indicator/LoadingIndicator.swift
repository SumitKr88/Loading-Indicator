...
class LoadingIndicator: UIView {
    ...
    static let sharedInstance: LoadingIndicator = LoadingIndicator()
    ...
    private var activityIndicator = UIActivityIndicatorView(style: UIActivityIndicatorView.Style.whiteLarge)
